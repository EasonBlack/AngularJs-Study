...
angular.module('bw.paging', []).directive('paging', function () {
            ...
            '<ul data-ng-hide="Hide" data-ng-class="ulClass"> ' +
                ...
                '<li><div class="input-group">' +
                    '<span class="input-group-btn">' +
                        '<button class="btn btn-default" type="button" style="border-bottom-left-radius: 0;border-top-left-radius: 0;border-left: 0;" ng-click="goToPage()">Go</button>' +
                    ' </span>' +
                    '<input  type="text" class="form-control" style="width:50px" ng-model="goPage">' +
                ' </div></li>' +
                '</ul>'
    };
    ...
    function fieldLink(scope, el, attrs) {
        ...
        scope.goToPage = function() {
            if(isNaN(scope.goPage)) return ;
            if(scope.goPage<=0 || scope.goPage>scope.pageSize ) return ;
            if(scope.goPage.indexOf('.')>0) return ;
            scope.page = scope.goPage;
            scope.pagingAction({
                page: scope.goPage,
